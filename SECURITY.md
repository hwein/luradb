...
LuraDB is pre-1.0. Only the latest published release receives security
fixes — please upgrade before reporting an issue found on an older version.
...
You'll get an acknowledgement within a few days. Depending on severity, a
fix ships as an out-of-band hotfix release or as part of the next regular
release.
